...
public class VariableInit {
	...
	VariableInit(int var){
		...
		//인스턴스 변수와 지역변수의 이름이 같을 때 둘을 구분하기 위해 인스턴스 변수 앞에 붙여 사용
		//생성자에 파라미터값이 있으면 기본값을 주지 않는다.
	}
...
//		}
		...
		//this()이전의 코드가의미 없는 코드가 될 수 있기 때문에 this()는 생성자의 첫줄에서만 사용할 수 있다.
