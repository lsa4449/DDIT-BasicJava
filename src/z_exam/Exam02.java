...
public class Exam02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		[2-9] 다음 중 형변환을 생략할 수 있는 것은? (모두 고르시오) d, e ->작은 것에서 큰 것으로 변환할 때(오른쪽이 더 작을 때) 형변환 생략
 				byte b = 10;
				char ch = 'A';
				int i = 100;
				long l = 1000L;
		...
		*/
		...
		[2-11] 다음중 변수를 잘못 초기화 한 것은? (모두 고르시오) a, b, c, d
				a. byte b = 256; -> 127까지 표현
				b. char c = ''; -> 값이 없음
				c. char answer = 'no'; -> 한 글자만 가능
				d. float f = 3.14 -> f생략
				e. double d = 1.4e3f; -> float 타입을 double에 저장하기 때문에 가능
		*/
