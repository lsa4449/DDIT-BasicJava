...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * << super >>
		 * - 부모 클리스의 인스턴스 주소가 저장된 변수이다
		 * - 부모 클래스의 멤버와 자식 클래스의 멤버의 이름이 중복될 때 둘을 구분하기 위해 사용한다
		 * 
		 * << super() >>
		 * - 생성자에서 부모 클래스의 생성자를 호출하기 위해 사용한다.
		 * - 자식 클래스 생성자의 첫줄에 super()가 있어야한다.
		 * - 없으면 컴파일러가 자동으로 추가한다.
		 * 
		 * << 오버라이딩 >>
		 * - 상속받은 메소드의 내용을 재정의하는 것이다.
		 * - 상속받은 메소드와 리턴타입, 메소드명, 피라미터가 같아야한다.
		 * - 상속받은 메소드보다 좁은 범위의 접근제어자로 변경할 수 없다.
